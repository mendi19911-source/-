...
if ($_SERVER['REQUEST_METHOD']==='POST') {
    ...
    try {
        ...
        $system .= "
** eSIM — כללים לכלל החברות:**
- לאשר ניוד לפני חיבור eSIM (סריקה מוקדמת מדי תשבש קליטת רשת)
- בעת סריקת ברקוד — המכשיר חייב להיות מחובר ל-Wi-Fi
- סריקה דרך הגדרות המכשיר בלבד — לא דרך אפליקציית מצלמה
- קוד QR הוא חד-פעמי — לא למחוק חבילת סלולר מהמכשיר

**התקנת eSIM לפי מכשיר:**
iPhone: הגדרות > סלולרי > הוספת eSIM > סריקת ברקוד
Android/סמסונג: הגדרות > חיבורים > מנהל כרטיסי SIM > הוספת eSIM > סריקת QR

**eSIM לפי חברה:**
- הוט: חיבור על מספר זמני, אחרי סריקה לעדכן בעסקה, ברקוד נשלח למייל
- סלקום: ברקוד למייל + הערות עסקה, לסרוק רק אחרי אישור ניוד
- גולן: ברקוד למייל (לא מופיע בעסקה). אם לא קיבל מייל — לעדכן אותנו
- פלאפון: אישור ניוד → סריקת ברקוד (הסריקה מפעילה הניוד). ברקוד לפני אישור = ניוד לא יתחיל
- WE/ויקום: ברקוד למייל בלבד. אחרי סריקה — לחייג ללקוח להשלמת הניוד
- פרטנר: אישור ניוד → סריקת ברקוד. לעדכן בעסקה שאושר ונסרק

**הוראת קבע — קודי מוסד:**
- סלקום: 25500 | פרטנר: 31274 | פלאפון: 2007 (SMS בלבד) | הוט: 36716 | גולן: 54528 | WECOM: 28444
- סלקום/הוט/פלאפון: קישור לחתימה נשלח ללקוח
- פרטנר: קישור + ת\"ז + אישור ניהול חשבון/צ'ק מבוטל
- גולן/WECOM: אישור הקמת הרשאה מהבנק + ת\"ז + פרטי חשבון
- בנקים: יהב, ירושלים, פאגי, וואן זירו, מסד — יש לשלוח אישור עד סוף החודש

**סים משני — עלויות:**
- סלקום: חד-פעמי 10₪ + 21.9₪/חודש (קווים רגילים וכשרים)
- פלאפון: חד-פעמי 10₪ + 21.9₪/חודש (רגיל + כשר עם טופס)
- פרטנר: חד-פעמי 10₪ + 20₪/חודש (קווים רגילים)
- הוט: ללא גלישה 15₪/חודש, עם גלישה 35₪/חודש (לא כשר, מול שירות לקוחות)
- גולן: 5.90₪/חודש (שיחות בלבד, קווים רגילים)

**טלפוני שירות לקוחות:**
- סלקום: 1800071071 | הוט: 1800800053 | פרטנר: 1800800054
- פלאפון: 1800050166 | גולן: 0587778888 | ויקום: 0515445595 | רמי לוי: 0768888600

**אישורי ניוד IVR (מחייגים מהסים הישן):**
- לסלקום: 1800071001 / 0529990333
- לפרטנר: 1800054005 / 0546990521
- לגולן: 0587778585
- להוט: 0535353800
- לפלאפון: 0505010010
- לויקום: 0776707626
